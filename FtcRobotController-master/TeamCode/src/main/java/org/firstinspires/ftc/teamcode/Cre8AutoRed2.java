...
@Autonomous(name = "Cre8AutoRed2")
public class Cre8AutoRed2 extends LinearOpMode
{
...
/** Go thru truss
                ...
                DriveForwardTime(.2,10500);
                **/
                Thread.sleep(2000);
                DriveForwardTime(DRIVE_POWER,1500);
                DriveBackwardTime(.1,2500);
                /**
                TurnLeftTime(.2,3000);
                DriveForwardTime(DRIVE_POWER,1500);
                TurnRightTime(.2,3000);
                DriveForwardTime(DRIVE_POWER,300);
                TurnRightTime(.2,1500);
