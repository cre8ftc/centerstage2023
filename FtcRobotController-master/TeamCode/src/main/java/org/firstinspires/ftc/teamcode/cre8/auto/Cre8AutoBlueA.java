package org.firstinspires.ftc.teamcode.cre8.auto;
...
@Autonomous(name = "Cre8AutoBlueA")
public class Cre8AutoBlueA extends LinearOpMode
{
    ...
    public void runOpMode() throws InterruptedException {
        ...
        if (opModeIsActive()) {
            ...
            Thread.sleep(2000);
            DriveForwardTime(DRIVE_POWER,2800);
            TurnLeftTime(.2,4000);
            DriveForwardTime(DRIVE_POWER,5000);
            TurnLeftTime(.2,4000);
            DriveForwardTime(.2,1500);
            StopDriving();
        }
    }
