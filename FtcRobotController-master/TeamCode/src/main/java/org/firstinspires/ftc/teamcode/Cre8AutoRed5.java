...
@Autonomous(name = "Cre8AutoRed5")
public class Cre8AutoRed5 extends LinearOpMode
{
    ...
    public void runOpMode() throws InterruptedException {
        ...
        if (opModeIsActive()) {
            ...
            while (opModeIsActive()) {
                ...
                DriveBackwardTime(.1,3000);
                /*Thread.sleep(2000);
                DriveForwardTime(DRIVE_POWER,2075);
                DriveBackwardTime(.1,3000);
                Thread.sleep(500);
                TurnRightTime(.2,4500);
                DriveForwardTime(.2,4500);
                StopDriving();*/
/**
                Thread.sleep(5000);
                ...
                TurnRightTime(DRIVE_POWER, 25);
                DriveForwardTime(DRIVE_POWER, 500);
                DriveBackwardTime(DRIVE_POWER,500);
                TurnRightTime(DRIVE_POWER,750);
                DriveForwardTime(DRIVE_POWER,1000);
                TurnRightTime(DRIVE_POWER,50);
                DriveForwardTime(DRIVE_POWER,1000);
                TurnLeftTime(DRIVE_POWER, 50);
                DriveForwardTime(DRIVE_POWER,1000);
                TurnRightTime( DRIVE_POWER,750);
                StopDriving();
 **/
